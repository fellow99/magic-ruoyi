...
insert into sys_tenant values(1, '000000', '主户', '', '主户', null, null, '后台管理系统', null, null, null, null, -1, '0', '0', 103, 1, sysdate(), null, null);
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1, '000000', 103, 'admin', '管理员', 'sys_user', '', '', '1', null, '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 103, 1, sysdate(), null, null, '管理员');
insert into sys_user values(3, '000000', 108, 'test1', '测试账号1', 'sys_user', '', '', '0', null, '$2a$10$b8yUzN0C71sbz.PhNOCgJe.Tu1yWC3RNrTyjSQ8p1W0.aaUXUJ.Ne', '0', '0', '127.0.0.1', sysdate(), 103, 1, sysdate(), 3, sysdate(), null);
insert into sys_user values(4, '000000', 102, 'test2', '测试账号2', 'sys_user', '', '', '0', null, '$2a$10$b8yUzN0C71sbz.PhNOCgJe.Tu1yWC3RNrTyjSQ8p1W0.aaUXUJ.Ne', '0', '0', '127.0.0.1', sysdate(), 103, 1, sysdate(), 4, sysdate(), null);
...
insert into sys_menu values('1630', 'API编辑', '3', '3', 'magic/web', 'magic/web/index', '', 1, 0, 'C', '0', '0', 'tool:magic-api:list', 'code', 103, 1, sysdate(), null, null, 'magic-api接口编辑菜单');
-- 测试菜单
...
insert into sys_config values(3, '000000', '主框架页-侧边栏主题',          'sys.index.sideTheme',           'theme-light',    'Y', 103, 1, sysdate(), null, null, '深色主题theme-dark，浅色主题theme-light' );
...
insert into sys_config values(11, '000000', 'OSS预览列表资源开关',         'sys.oss.previewListResource',   'false',          'Y', 103, 1, sysdate(), null, null, 'true:开启, false:关闭');
...
insert into sys_oss_config values (1, '000000', 'minio',  'root',            '123456',        'default',             '', '127.0.0.1:9000',                '','N', '',             '1' ,'0', '', 103, 1, sysdate(), 1, sysdate(), null);
insert into sys_oss_config values (5, '000000', 'image',  'root',            '123456',        'default',             'image', '127.0.0.1:9000',           '','N', '',             '1' ,'1', '', 103, 1, sysdate(), 1, sysdate(), null);
